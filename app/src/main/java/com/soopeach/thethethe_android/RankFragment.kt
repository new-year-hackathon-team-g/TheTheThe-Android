...
import com.soopeach.thethethe_android.databinding.RankRetrofitBinding
...
class RankAdapter(val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    =RankViewHolder(RankRetrofitBinding.inflate(LayoutInflater.from(parent.context),parent,false))

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val binding=(holder as RankViewHolder).binding
    }
}
class RankFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.RecyclerView.adapter = RankAdapter(requireContext())

        binding.rankingMy
        binding.coupleMemoMy
        binding.coupleNameMy
